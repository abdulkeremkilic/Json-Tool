      ...
      // Popup controls
      searchBtn.addEventListener("click", () => togglePopup(searchPopup, searchBtn));
      scriptBtn.addEventListener("click", () => togglePopup(scriptPopup, scriptBtn));
      
      cancelSearch.addEventListener("click", () => closePopup(searchPopup, searchBtn));
      cancelScript.addEventListener("click", () => closePopup(scriptPopup, scriptBtn));
